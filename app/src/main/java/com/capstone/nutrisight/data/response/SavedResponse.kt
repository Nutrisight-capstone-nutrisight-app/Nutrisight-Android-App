...
data class SavedResponse(
	...
	@field:SerializedName("savedProduct")
	val savedProduct: List<SavedProductItem>
)
...
data class SavedProductItem(
	...
	@field:SerializedName("ProductsOnSaves")
	val productsOnSaves: List<ProductsOnSavesItem>
)

data class ProductsOnSavesItem(
...
fun parseSavedResponse(savedResponse: SavedResponse): List<ProductsOnSavesItem> {
	return savedResponse.savedProduct.flatMap { savedProductItem ->
		savedProductItem.productsOnSaves.map { productOnSaveItem ->
			productOnSaveItem.copy(createdAt = savedProductItem.createdAt)
		}
	}
}
